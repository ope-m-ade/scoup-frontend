...
export const facultyData: Faculty[] = [
  {
    id: 1,
    type: "Faculty Expert",
    name: "Dr. Kwang-Wook Gang",
    title: "Professor of Business and Technology Strategy",
    department: "Mathematical and Computer Sciences",
    office: "Room 345, Henson Science Hall",
    phone: "(410) 543-6365",
    email: "kxgang@salisbury.edu",
    description:
      "Researcher focused on entrepreneurial activities, technological strategies, and disruptive innovation in evolving industries. Dr. Gang’s work examines firm growth, corporate governance, and product strategy in emerging economies. He emphasizes experiential, case-based learning in the classroom.",
    aiKeywords: [
      "entrepreneurship",
    ...
    photo: "https://www.salisbury.edu/_images/directory/kxgang.jpg",
    availability: "Available",
    projects: "6 active",
    category: "faculty",
    // homepage: "https://www.salisbury.edu/faculty-and-staff/kxgang/",
    // publications: [
    //   "Jeong, Min, Kim, Byeoung-Im, and Gang, KwangWook (2017). Competition, product line length, and firm survival: evidence from the US printer industry. Technology Analysis and Strategic Management, 29(7), 762–774.",
    //   "Gang, KwangWook and Ravichandran, T. (2015). Exploring the Determinants of Knowledge Exchange in Virtual Communities. IEEE Transactions on Engineering Management, 62(1), 89–99."
    // ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    photo:
      "https://thumbs.dreamstime.com/b/arms-crossed-businessman-portrait-pride-studio-mockup-start-up-professional-worker-person-face-arms-crossed-300754216.jpg",
    availability: "Available",
    projects: "5 active",
    category: "faculty",
  },
